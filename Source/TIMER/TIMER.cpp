...
void TIMER::break_configure(TIMER_Break *break_config)
{
    ...
    write_bits(*this, TIMER_Regs::CCHP, static_cast<uint32_t>(CCHP_Bits::BRKEN), static_cast<uint32_t>(config_.break_params.break_state),
               static_cast<uint32_t>(CCHP_Bits::BRKP), static_cast<uint32_t>(config_.break_params.break_polarity),
               static_cast<uint32_t>(CCHP_Bits::OAEN), static_cast<uint32_t>(config_.break_params.output_auto_state),
               static_cast<uint32_t>(CCHP_Bits::ROS), static_cast<uint32_t>(config_.break_params.ros_state),
               static_cast<uint32_t>(CCHP_Bits::IOS), static_cast<uint32_t>(config_.break_params.ios_state),
               static_cast<uint32_t>(CCHP_Bits::PROT), static_cast<uint32_t>(config_.break_params.protection),
               static_cast<uint32_t>(CCHP_Bits::DTCFG), static_cast<uint32_t>(config_.break_params.dead_time));
}
...
void TIMER::output_compare_init(Timer_Channel channel)
{
    ...
    case Timer_Channel::CH0:
        ...
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH0EN), static_cast<uint32_t>(config_.output_params.state),
                   static_cast<uint32_t>(CHCTL2_Bits::CH0P), static_cast<uint32_t>(config_.output_params.polarity));
        if ((base_index_ == TIMER_Base::TIMER0_BASE) || (base_index_ == TIMER_Base::TIMER7_BASE)) {
            write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH0NEN), static_cast<uint32_t>(config_.output_params.companion_state),
                       static_cast<uint32_t>(CHCTL2_Bits::CH0NP), static_cast<uint32_t>(config_.output_params.companion_polarity));
            write_bits(*this, TIMER_Regs::CTL1, static_cast<uint32_t>(CTL1_Bits::ISO0), static_cast<uint32_t>(config_.output_params.idle_state),
                       static_cast<uint32_t>(CTL1_Bits::ISO0), static_cast<uint32_t>(config_.output_params.companion_idle_state));
        }
        break;
    case Timer_Channel::CH1:
        write_bit(*this, TIMER_Regs::CHCTL0, static_cast<uint32_t>(CHCTL0_Bits::CH1MS), Clear);
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH1EN), static_cast<uint32_t>(config_.output_params.state),
                   static_cast<uint32_t>(CHCTL2_Bits::CH1EN), static_cast<uint32_t>(config_.output_params.polarity));
        if ((base_index_ == TIMER_Base::TIMER0_BASE) || (base_index_ == TIMER_Base::TIMER7_BASE)) {
            write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH1NEN), static_cast<uint32_t>(config_.output_params.companion_state),
                       static_cast<uint32_t>(CHCTL2_Bits::CH1NP), static_cast<uint32_t>(config_.output_params.companion_polarity));
            write_bits(*this, TIMER_Regs::CTL1, static_cast<uint32_t>(CTL1_Bits::ISO1), static_cast<uint32_t>(config_.output_params.idle_state),
                       static_cast<uint32_t>(CTL1_Bits::ISO1N), static_cast<uint32_t>(config_.output_params.companion_idle_state));
        }
        break;
    case Timer_Channel::CH2:
        write_bit(*this, TIMER_Regs::CHCTL1, static_cast<uint32_t>(CHCTL1_Bits::CH2MS), Clear);
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH2EN), static_cast<uint32_t>(config_.output_params.state),
                   static_cast<uint32_t>(CHCTL2_Bits::CH2P), static_cast<uint32_t>(config_.output_params.polarity));
        if ((base_index_ == TIMER_Base::TIMER0_BASE ) || (base_index_ == TIMER_Base::TIMER7_BASE)) {
            write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH2NEN), static_cast<uint32_t>(config_.output_params.companion_state),
                       static_cast<uint32_t>(CHCTL2_Bits::CH2NP), static_cast<uint32_t>(config_.output_params.companion_polarity));
            write_bits(*this, TIMER_Regs::CTL1, static_cast<uint32_t>(CTL1_Bits::ISO2), static_cast<uint32_t>(config_.output_params.idle_state),
                       static_cast<uint32_t>(CTL1_Bits::ISO2N), static_cast<uint32_t>(config_.output_params.companion_idle_state));
        }
        break;
    case Timer_Channel::CH3:
        write_bit(*this, TIMER_Regs::CHCTL1, static_cast<uint32_t>(CHCTL1_Bits::CH3MS), Clear);
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH3EN), static_cast<uint32_t>(config_.output_params.state),
                   static_cast<uint32_t>(CHCTL2_Bits::CH3P), static_cast<uint32_t>(config_.output_params.polarity));
        if ((base_index_ == TIMER_Base::TIMER0_BASE) || (base_index_ == TIMER_Base::TIMER7_BASE)) {
...
void TIMER::input_capture_init(Timer_Channel channel)
{
    ...
    case Timer_Channel::CH0:
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH0EN), Clear,
                   ...
                   static_cast<uint32_t>(CHCTL2_Bits::CH0P), static_cast<uint32_t>(config_.input_params.polarity),
                   static_cast<uint32_t>(CHCTL2_Bits::CH0EN), Set);
        write_bits(*this, TIMER_Regs::CHCTL0, static_cast<uint32_t>(CHCTL0_Bits::CH0MS), static_cast<uint32_t>(config_.input_params.source_select),
                   static_cast<uint32_t>(CHCTL0_Bits::CH0CAPFLT), static_cast<uint32_t>(config_.input_params.digital_filter),
    ...
    case Timer_Channel::CH1:
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH1EN), Clear,
                   ...
                   static_cast<uint32_t>(CHCTL2_Bits::CH1P), static_cast<uint32_t>(config_.input_params.polarity),
                   static_cast<uint32_t>(CHCTL2_Bits::CH1EN), Set);
        write_bits(*this, TIMER_Regs::CHCTL0, static_cast<uint32_t>(CHCTL0_Bits::CH1MS), static_cast<uint32_t>(config_.input_params.source_select),
                   static_cast<uint32_t>(CHCTL0_Bits::CH1CAPFLT), static_cast<uint32_t>(config_.input_params.digital_filter),
    ...
    case Timer_Channel::CH2:
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH2EN), Clear,
                   ...
                   static_cast<uint32_t>(CHCTL2_Bits::CH2P), static_cast<uint32_t>(config_.input_params.polarity),
                   static_cast<uint32_t>(CHCTL2_Bits::CH2EN), Set);
        write_bits(*this, TIMER_Regs::CHCTL1, static_cast<uint32_t>(CHCTL1_Bits::CH2MS), static_cast<uint32_t>(config_.input_params.source_select),
                   static_cast<uint32_t>(CHCTL1_Bits::CH2CAPFLT), static_cast<uint32_t>(config_.input_params.digital_filter),
    ...
    case Timer_Channel::CH3:
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH3EN), Clear,
                   static_cast<uint32_t>(CHCTL2_Bits::CH3P), static_cast<uint32_t>(config_.input_params.polarity),
                   static_cast<uint32_t>(CHCTL2_Bits::CH3EN), Set);

        write_bits(*this, TIMER_Regs::CHCTL1, static_cast<uint32_t>(CHCTL1_Bits::CH3MS), static_cast<uint32_t>(config_.input_params.source_select),
                   static_cast<uint32_t>(CHCTL1_Bits::CH3CAPFLT), static_cast<uint32_t>(config_.input_params.digital_filter),
...
void TIMER::input_pwm_capture_enable(Timer_Channel channel, TIMER_Input_Capture *pwm)
{
    ...
    if (channel == Timer_Channel::CH0) {
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH0EN), Clear,
                   static_cast<uint32_t>(CHCTL2_Bits::CH0NP), Clear,
                   static_cast<uint32_t>(CHCTL2_Bits::CH0P), static_cast<uint32_t>(pwm->polarity));
        write_bits(*this, TIMER_Regs::CHCTL0, static_cast<uint32_t>(CHCTL0_Bits::CH0MS), static_cast<uint32_t>(pwm->source_select),
                   static_cast<uint32_t>(CHCTL0_Bits::CH0CAPFLT), static_cast<uint32_t>(pwm->digital_filter));
        ...
        write_bits(*this, TIMER_Regs::CHCTL0, static_cast<uint32_t>(CHCTL0_Bits::CH1MS), static_cast<uint32_t>(source),
                   static_cast<uint32_t>(CHCTL0_Bits::CH1CAPFLT), static_cast<uint32_t>(pwm->digital_filter));
        ...
        write_bits(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH1EN), Clear,
                   static_cast<uint32_t>(CHCTL2_Bits::CH1NP), Clear,
                   static_cast<uint32_t>(CHCTL2_Bits::CH1P), static_cast<uint32_t>(pwm->polarity));
        write_bits(*this, TIMER_Regs::CHCTL0, static_cast<uint32_t>(CHCTL0_Bits::CH1MS), static_cast<uint32_t>(pwm->source_select),
                   static_cast<uint32_t>(CHCTL0_Bits::CH1CAPFLT), static_cast<uint32_t>(pwm->digital_filter));
        write_bit(*this, TIMER_Regs::CHCTL2, static_cast<uint32_t>(CHCTL2_Bits::CH1EN), Set);
        set_input_capture_prescaler(Timer_Channel::CH1, pwm->prescaler);
        // CH0
